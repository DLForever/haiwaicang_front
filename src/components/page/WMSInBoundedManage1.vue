...
//					2: 'info',
		...
		methods: {
			...
			getData() {
				...
				this.$axios.get('/admin/store_ins?page=' + this.cur_page + '&is_quick=false&s_status=1' + '&user_id=' + this.select_cate + '&fnsku=' + this.search_fnsku + '&status=' + this.statusSelect + '&logistics_number=' + this.search_logistics_number, {
					headers: {
