...
<script>
    ...
    //             }
				...
				this.$axios.get('/store_ins?page=' + this.cur_page + '&is_quick=0&s_status=1' + '&fnsku=' + this.search_fnsku + '&logistics_number=' + this.search_logistics_number + '&status=' + this.statusSelect, {
					headers: {
