		...
		<div class="container">
			<div class="handle-box">
				...
				<el-button type="primary">
					<a style="color:#fff;" :href="$axios.defaults.baseURL + '/admin/store_ins/export_url?s_status=1&is_quick=1&token=' + export_token + '&user_id=' + select_cate + '&status=' + statusSelect + '&logistics_number=' + search_logistics_number + '&batch_number=' + search_batch_number">导出</a>
				</el-button>
				<div class="search">
					<!-- <span>用户:</span> -->
					用户:
...
//					2: 'info',
		...
		methods: {
			...
			getData() {
				...
				this.$axios.get('/admin/store_ins?page=' + this.cur_page + '&is_quick=1&s_status=1' + '&user_id=' + this.select_cate + '&fnsku=' + this.search_fnsku + '&status=' + this.statusSelect + '&logistics_number=' + this.search_logistics_number + '&batch_number=' + this.search_batch_number, {
					headers: {
