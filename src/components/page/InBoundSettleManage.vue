	...
	<div class="table">
		<div class="crumbs">
			<el-breadcrumb separator="/">
				...
				<el-breadcrumb-item>已结算</el-breadcrumb-item>
			</el-breadcrumb>
		</div>
		<div class="container">
	...
	export default {
		...
		methods: {
			...
			getData() {
				...
				this.$axios.get('/store_ins?page=' + this.cur_page + '&batch_store_in_id=' + this.select_batch + '&fnsku=' + this.search_fnsku + '&status=6', {
					headers: {
