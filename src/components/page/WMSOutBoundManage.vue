	...
	<div>
		...
		<el-dialog title="详情" :visible.sync="detailVisible" width="50%">
			...
			<div id="printJS-form">
				...
				<barcode :value="barcode" :options="{displayValue:false}" tag="img" width="200" height="100"></barcode>
				<el-table :data="outBoundTable" border style="width: 100%">
					...
					<el-table-column prop="sum" label="新标" width="120px">
						<template slot-scope="scope">
							...
							<!-- <span>{{scope.row.pictures[0].url}}</span> -->
						</template>
					</el-table-column>
				...
				<br>
				<el-table :data="outBoundTable" border style="width: 100%">
					<el-table-column prop="fnsku" label="fnsku" width="307"></el-table-column>
					<!-- <el-table-column prop="sum" label="数量"></el-table-column> -->
					<el-table-column prop="labal_ware_houses" label="取货详情"></el-table-column>
				</el-table>
			</div>
		...
		<el-dialog title="详情" :visible.sync="checkVisible" width="65%">
			...
			<br>
			<el-table :data="checkData3" border style="width: 100%">
				<el-table-column prop="sum" label="数量"></el-table-column>
			...
			<br>
			<el-table :data="checkData4" border style="width: 100%" @selection-change="store_insSelectionChange">
				<el-table-column type="selection" width="55"></el-table-column>
			...
			<br>
			<el-table :data="checkData5" border style="width: 100%" @selection-change="productSelectionChange">
				<el-table-column type="selection" width="55"></el-table-column>
				<el-table-column prop="fnsku" label="fnsku"></el-table-column>
	...
	export default {
		...
		data: function() {
			return {
				...
				package_ramark: '',
				checkData: undefined,
				checkData2: undefined,
				checkData3: undefined,
				checkData4: undefined,
				checkData5: undefined,
				check_id: undefined,
